"""
Django settings for vetste5379raapp_1 project.
...
ROOT_URLCONF = 'vetste5379raapp_1.urls'
...
WSGI_APPLICATION = 'vetste5379raapp_1.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "vetste5379raapp Support <support@vetste5379raapp-1.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "vetste5379raapp_1 API",
    "DESCRIPTION": "API documentation for vetste5379raapp_1 App",
    "VERSION": "v1",
}
...
if AS_BUCKET_NAME:
    ...
    DEFAULT_FILE_STORAGE = "vetste5379raapp_1.storage_backends.AzureMediaStorage"
    STATICFILES_STORAGE = "vetste5379raapp_1.storage_backends.AzureStaticStorage"
